...
<html lang="en">
<head>
    <title>HEABEOP::회원약관</title>
    <jsp:include page="../layout/head.jsp" />
    <link rel="stylesheet" href="${path }/resources/css/sub.css">
</head>
<body>
<section class="bg-image join_agree my-5">
                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <h2 class="text-uppercase text-center mt-3 mb-5">회원 약관 동의</h2>
...
제33조(분쟁의 해결) "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다.
                            ...
                            <div class="d-flex justify-content check_area ml-4 mt-3 mb-4">
...
③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.
                            ...
                            <div class="form-check d-flex justify-content-center mb-5">
                                <input type="checkbox" id="allCheck" name="allCheck" class="mr-2">
