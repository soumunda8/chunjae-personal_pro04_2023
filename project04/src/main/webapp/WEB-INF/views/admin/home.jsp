                            ...
                            <div class="review-block">
                                <div class="row">
                                    <div class="col-sm-auto p-r-0">
                                        <img src="${path }/resources/image/admin/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col-sm-auto p-r-0">
                                        <img src="${path }/resources/image/admin/avatar-4.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                                    </div>
                                    <div class="col">
