...
<body>
    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <!-- [ breadcrumb ] end -->
            <!-- [ Main Content ] start -->
            <form action="${path }/admin/productAdd.do" name="frm1" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="proNm" id="proNm" placeholder="제품 이름을 입력하세요." aria-describedby="제품 이름 도움" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="proPrice" id="proPrice" placeholder="제품 가격을 입력하세요." aria-describedby="제품 가격 도움" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
