                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control uploadThumbnail" name="uploadThumbnail" accept="image/*" id="uploadThumbnail" multiple required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control uploadVideo" name="uploadVideo" id="uploadVideo" accept="video/*" multiple required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
