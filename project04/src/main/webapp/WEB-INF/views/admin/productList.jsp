    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
                ...
                <div class="col-xl-12">
                    <div class="card">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <c:forEach items="${productList }" var="product" varStatus="status">
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="${path }/admin/getProduct.do?no=${product.proNo }">${product.proNm }</a></td>
                                                <td class="text-center"><fmt:formatNumber value="${product.proPrice }" pattern="#,###" /> 원</td>
                        ...
                        <c:if test="${empty productList }">
                            <p class="f-18 f-w-600 text-center mt-3">등록된 제품이 없습니다.</p>
                        </c:if>
                    </div>
                </div>
            </div>
            <div class="row justify-content-md-end">
                <div class="col-md-1">
                    <a href="${path }/admin/productAdd.do" class="btn btn-primary" style="width:100%;">등록</a>
                </div>
            </div>
            <!-- [ Main Content ] end -->
        </div>
